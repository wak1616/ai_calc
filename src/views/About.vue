  ...
  <v-container>
    <v-row>
      <v-col>
        ...
        <div class="text-body-1 mb-4">The author, Joaquin De Rojas, MD, has extensive experience using femtosceondlaser arcuate keratotomies to improve visual outcomes for his patients.</div>
